...
from integrations.models import EmisSchool, EmisJobTitle  # adjust import if your lookup is elsewhere
...
class Staff(models.Model):
    ...
    def active_memberships(self):
        ...
        return self.memberships.filter(models.Q(end_date__isnull=True) | models.Q(end_date__gte=today))
