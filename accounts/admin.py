...
class StaffSchoolMembershipInline(admin.TabularInline):
    ...
    readonly_fields = ("active_now","created_at", "created_by", "last_updated_at", "last_updated_by")
...
class StaffAdmin(CreatedUpdatedAuditMixin, admin.ModelAdmin):
    list_display = ("user", "created_at", "created_by", "last_updated_at", "last_updated_by")
